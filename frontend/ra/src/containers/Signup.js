...
class RegistrationForm extends React.Component {
  ...
  handleSubmit = e => {
    ...
    this.props.history.push('/'); /*once logged in wil redirect*/
  };
...
const mapDispatchToProps = dispatch => {
    return {
        onAuth: (usernane, email, password1, password2) => dispatch(actions.authSignup(usernane, email, password1, password2))
    }
}
